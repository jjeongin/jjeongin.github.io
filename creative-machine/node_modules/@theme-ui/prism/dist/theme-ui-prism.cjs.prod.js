...
function ThemeUIPrism({
  ...
  return themeUi.jsx(Highlight__default['default'], _extends({}, Highlight.defaultProps, props, {
    code: children.trim(),
    language: lang,
    theme: undefined
  }), ({
    ...
    return themeUi.jsx(themeUi.Themed.pre, {
      ...
      return themeUi.jsx("div", lineProps, line.map((token, key) => themeUi.jsx("span", _extends({}, getTokenProps({
        token,
        key
      }), {
        sx: token.empty ? {
