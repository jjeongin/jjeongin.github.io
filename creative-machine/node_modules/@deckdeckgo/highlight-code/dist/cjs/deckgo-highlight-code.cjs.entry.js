...
const index = require('./index-5157f505.js');
const deckdeckgoHighlightCodeLanguages = require('./deckdeckgo-highlight-code-languages-d0d7a71f.js');
...
const loadMainScript = ({ lang, reload = false, prismLanguageLoaded }) => {
  return new Promise(async (resolve) => {
    ...
    const definition = deckdeckgoHighlightCodeLanguages.deckdeckgoHighlightCodeLanguages[lang];
...
let DeckdeckgoHighlightCode = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: hostClass, onClick: () => this.edit() }, this.renderCarbon(), this.renderUbuntu(), this.renderHighlightStyle(), index.h("div", { class: "container", ref: (el) => (this.refContainer = el) }, index.h("code", { class: ((_a = this.highlightLines) === null || _a === void 0 ? void 0 : _a.length) > 0 ? 'highlight' : undefined, contentEditable: this.editable, onBlur: async () => await this.applyCode(), onInput: () => this.inputCode(), onKeyDown: ($event) => F($event), ref: (el) => (this.refCode = el) }), index.h("slot", { name: "code" }))));
  }
