...
let DeckdeckgoHighlightCode = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    ...
    return (h(Host, { class: hostClass, onClick: () => this.edit() }, this.renderCarbon(), this.renderUbuntu(), this.renderHighlightStyle(), h("div", { class: "container", ref: (el) => (this.refContainer = el) }, h("code", { class: ((_a = this.highlightLines) === null || _a === void 0 ? void 0 : _a.length) > 0 ? 'highlight' : undefined, contentEditable: this.editable, onBlur: async () => await this.applyCode(), onInput: () => this.inputCode(), onKeyDown: ($event) => F($event), ref: (el) => (this.refCode = el) }), h("slot", { name: "code" }))));
  }
...
const DeckgoHighlightCode = /*@__PURE__*/proxyCustomElement(DeckdeckgoHighlightCode, [1,"deckgo-highlight-code",{"language":[513],"highlightLines":[513,"highlight-lines"],"lineNumbers":[516,"line-numbers"],"terminal":[513],"editable":[4],"theme":[513],"revealProgress":[1025,"reveal-progress"],"themeStyle":[32],"loaded":[32],"highlightRows":[32]},[[5,"prismLanguageLoaded","onLanguageLoaded"],[5,"prismLanguageError","onLanguageError"],[8,"copy","onCopyCleanZeroWidthSpaces"]]]);
