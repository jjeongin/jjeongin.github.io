...
var React = _interopRequireWildcard(__webpack_require__(3072));
...
var _react = __webpack_require__(3072);
...
var _react = _interopRequireDefault(__webpack_require__(3072));
...
exports.components={"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 883).then(__webpack_require__.bind(__webpack_require__, 429)),"component---src-templates-about-page-js":()=>__webpack_require__.e(/* import() | component---src-templates-about-page-js */ 311).then(__webpack_require__.bind(__webpack_require__, 3550)),"component---src-templates-download-page-js":()=>__webpack_require__.e(/* import() | component---src-templates-download-page-js */ 164).then(__webpack_require__.bind(__webpack_require__, 7747)),"component---src-templates-home-page-js":()=>__webpack_require__.e(/* import() | component---src-templates-home-page-js */ 614).then(__webpack_require__.bind(__webpack_require__, 7326)),"component---src-templates-reference-page-js":()=>__webpack_require__.e(/* import() | component---src-templates-reference-page-js */ 712).then(__webpack_require__.bind(__webpack_require__, 7610))};
...
const trimmedPathname=stripPrefix(pathname,decodeURIComponent("/creative-machine"))// Remove any hashfragment
...
if(this.staticQueryDb[staticQueryHash]){const jsonPayload=this.staticQueryDb[staticQueryHash];return{staticQueryHash,jsonPayload};}return this.memoizedGet(`${"/creative-machine"}/page-data/sq/d/${staticQueryHash}.json`).then(req=>{const jsonPayload=JSON.parse(req.responseText);return{staticQueryHash,jsonPayload};}).catch(()=>{throw new Error(`We couldn't load "${"/creative-machine"}/page-data/sq/d/${staticQueryHash}.json"`);});})).then(staticQueryResults=>{const staticQueryResultsMap={};staticQueryResults.forEach(({staticQueryHash,jsonPayload})=>{staticQueryResultsMap[staticQueryHash]=jsonPayload;this.staticQueryDb[staticQueryHash]=jsonPayload;});return staticQueryResultsMap;});return Promise.all([componentChunkPromise,staticQueryBatchPromise]).then(([pageResources,staticQueryResults])=>{let payload;if(pageResources){payload={...pageResources,staticQueryResults};finalResult.payload=payload;emitter.emit(`onPostLoadPageResources`,{page:payload,pageResources:payload});}this.pageDb.set(pagePath,finalResult);if(finalResult.error){return{error:finalResult.error,status:finalResult.status};}return payload;})// when static-query fail to load we throw a better error
...
/* harmony export */ });
const React=__webpack_require__(3072);const{grabMatchParams}=__webpack_require__(9755);const{createElement}=__webpack_require__(3072);const{StaticQueryContext}=__webpack_require__(9572);const{headExportValidator,filterHeadProps,warnForInvalidTags}=__webpack_require__(8317);const{ServerLocation,Router}=__webpack_require__(3631);const{renderToString}=__webpack_require__(8727);const{parse}=__webpack_require__(698);const{VALID_NODE_NAMES}=__webpack_require__(2460);function headHandlerForSSR({pageComponent,setHeadComponents,staticQueryContext,pageData,pagePath}){if(pageComponent!==null&&pageComponent!==void 0&&pageComponent.Head){headExportValidator(pageComponent.Head);function HeadRouteHandler(props){var _pageData$result,_pageData$result$page;const _props={...props,...pageData.result,params:{...grabMatchParams(props.location.pathname),...(((_pageData$result=pageData.result)===null||_pageData$result===void 0?void 0:(_pageData$result$page=_pageData$result.pageContext)===null||_pageData$result$page===void 0?void 0:_pageData$result$page.__params)||{})}};return createElement(pageComponent.Head,filterHeadProps(_props));}const routerElement=/*#__PURE__*/React.createElement(StaticQueryContext.Provider,{value:staticQueryContext},/*#__PURE__*/React.createElement(ServerLocation,{url:`${"/creative-machine"}${pagePath}`},/*#__PURE__*/React.createElement(Router,{baseuri:"/creative-machine",component:({children})=>/*#__PURE__*/React.createElement(React.Fragment,null,children)},/*#__PURE__*/React.createElement(HeadRouteHandler,{path:"/*"}))));// extract head nodes from string
...
"use strict";
module.exports = require("/Users/jlee/src/creative-machine-website/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/Users/jlee/src/creative-machine-website/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/Users/jlee/src/creative-machine-website/node_modules/react/index.js");
...
var React = __webpack_require__(3072);
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-753987768525edda177d.js"],"app":["/app-e4731ae1c8c835c4ebfb.js"],"component---src-pages-404-js":["/component---src-pages-404-js-825dd3d9ab95eefc6e28.js"],"component---src-templates-about-page-js":["/component---src-templates-about-page-js-02a3982f457448df8cce.js"],"component---src-templates-download-page-js":["/component---src-templates-download-page-js-6c07e4b5b44021c55a3f.js"],"component---src-templates-home-page-js":["/component---src-templates-home-page-js-f5762d5385662ae546c7.js"],"component---src-templates-reference-page-js":["/component---src-templates-reference-page-js-d10a2d0a6ffb534a149f.js"]}');
...
/******/ 			return "" + {"164":"component---src-templates-download-page-js","311":"component---src-templates-about-page-js","614":"component---src-templates-home-page-js","712":"component---src-templates-reference-page-js","883":"component---src-pages-404-js"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/* harmony export */ });
/* global HAS_REACT_18 */const React=__webpack_require__(3072);const path=__webpack_require__(1423);const{renderToString,renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(8727);const{ServerLocation,Router,isRedirect}=__webpack_require__(3631);const merge=__webpack_require__(9996);const{StaticQueryContext}=__webpack_require__(9572);const fs=__webpack_require__(7239);const{WritableAsPromise}=__webpack_require__(5897);const{RouteAnnouncerProps}=__webpack_require__(236);const{apiRunner,apiRunnerAsync}=__webpack_require__(4067);const asyncRequires=__webpack_require__(5418);const{version:gatsbyVersion}=__webpack_require__(1741);const{grabMatchParams}=__webpack_require__(9755);const chunkMapping=__webpack_require__(9804);const{headHandlerForSSR}=__webpack_require__(923);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
...
if(!isRedirect(e))throw e;}}apiRunner(`onRenderBody`,{setHeadComponents,setHtmlAttributes,setBodyAttributes,setPreBodyComponents,setPostBodyComponents,setBodyProps,pathname:pagePath,loadPageDataSync,bodyHtml,scripts,styles,pathPrefix:"/creative-machine"});reversedScripts.forEach(script=>{// Add preload/prefetch <link>s magic comments
if(script.shouldGenerateLink){headComponents.push(/*#__PURE__*/React.createElement("link",{as:"script",rel:script.rel,key:script.name,href:`${"/creative-machine"}/${script.name}`}));}});reversedStyles.forEach(style=>{// Add <link>s for styles that should be prefetched
// otherwise, inline as a <style> tag
if(style.rel===`prefetch`){headComponents.push(/*#__PURE__*/React.createElement("link",{as:"style",rel:style.rel,key:style.name,href:`${"/creative-machine"}/${style.name}`}));}else{headComponents.unshift(/*#__PURE__*/React.createElement("style",{"data-href":`${"/creative-machine"}/${style.name}`,"data-identity":`gatsby-global-css`,dangerouslySetInnerHTML:{__html:style.content}}));}});// Add page metadata for the current page
